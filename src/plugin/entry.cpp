...
BEGIN_FACTORY_DEF(stringCompanyName, "https://github.com/alexames/fl-lua",
...
DEF_CLASS2(INLINE_UID_FROM_FUID(kProcessorUID), PClassInfo::kManyInstances,
           ...
           FLLuaVST3Category, FULL_VERSION_STR, kVstVersionString,
...
DEF_CLASS2(INLINE_UID_FROM_FUID(kControllerUID), PClassInfo::kManyInstances,
           ...
           FULL_VERSION_STR, kVstVersionString, FLLuaController::createInstance)
