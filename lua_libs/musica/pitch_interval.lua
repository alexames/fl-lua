...
PitchInterval = llx.class('PitchInterval')({
  ...
  __mul = function(self, coeffecient)
    ...
    return PitchInterval({
      number = coeffecient * self.number,
  ...
  __tostring = function(self)
    ...
    return string.format(
      'PitchInterval{number=%s,accidentals=%s}',
      self.number,
      self.accidentals
    )
  end,
...
PitchInterval.unison =
  PitchInterval({ number = 0, quality = IntervalQuality.perfect })
PitchInterval.augmented_unison =
  PitchInterval({ number = 0, quality = IntervalQuality.augmented })

PitchInterval.diminished_second =
  PitchInterval({ number = 1, quality = IntervalQuality.diminished })
PitchInterval.minor_second =
  PitchInterval({ number = 1, quality = IntervalQuality.minor })
PitchInterval.major_second =
  PitchInterval({ number = 1, quality = IntervalQuality.major })
PitchInterval.augmented_second =
  PitchInterval({ number = 1, quality = IntervalQuality.augmented })

PitchInterval.diminished_third =
  PitchInterval({ number = 2, quality = IntervalQuality.diminished })
PitchInterval.minor_third =
  PitchInterval({ number = 2, quality = IntervalQuality.minor })
PitchInterval.major_third =
  PitchInterval({ number = 2, quality = IntervalQuality.major })
PitchInterval.augmented_third =
  PitchInterval({ number = 2, quality = IntervalQuality.augmented })

PitchInterval.diminished_fourth =
  PitchInterval({ number = 3, quality = IntervalQuality.diminished })
PitchInterval.perfect_fourth =
  PitchInterval({ number = 3, quality = IntervalQuality.perfect })
PitchInterval.augmented_fourth =
  PitchInterval({ number = 3, quality = IntervalQuality.augmented })

PitchInterval.diminished_fifth =
  PitchInterval({ number = 4, quality = IntervalQuality.diminished })
PitchInterval.perfect_fifth =
  PitchInterval({ number = 4, quality = IntervalQuality.perfect })
PitchInterval.augmented_fifth =
  PitchInterval({ number = 4, quality = IntervalQuality.augmented })

PitchInterval.diminished_sixth =
  PitchInterval({ number = 5, quality = IntervalQuality.diminished })
PitchInterval.minor_sixth =
  PitchInterval({ number = 5, quality = IntervalQuality.minor })
PitchInterval.major_sixth =
  PitchInterval({ number = 5, quality = IntervalQuality.major })
PitchInterval.augemented_sixth =
  PitchInterval({ number = 5, quality = IntervalQuality.augmented })

PitchInterval.dimished_seventh =
  PitchInterval({ number = 6, quality = IntervalQuality.diminished })
PitchInterval.minor_seventh =
  PitchInterval({ number = 6, quality = IntervalQuality.minor })
PitchInterval.major_seventh =
  PitchInterval({ number = 6, quality = IntervalQuality.major })
PitchInterval.augmented_seventh =
  PitchInterval({ number = 6, quality = IntervalQuality.augmented })

PitchInterval.dimished_octave =
  PitchInterval({ number = 7, quality = IntervalQuality.diminished })
PitchInterval.octave =
  PitchInterval({ number = 7, quality = IntervalQuality.perfect })
